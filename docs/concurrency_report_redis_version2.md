...
### 1초당 10000req
- 1초당 10000개 요청시 50%만 발급 성공을 하고 있어 lettuce.pool을 조정하였습니다.
- 조정 전 
![1초당 10000개스레드 실패](./image/1_10000_stream_fail.png)
- 조정 후
![1초당 10000개스레드 성공](./image/1s_10000_stream_suc.png)
...
구현하고 테스트 하는데는 조금 더 까다로워 진것 같긴 하지만...
두번의 개선을 거쳐 1초당 5000개 요청 테스트를 진행 할 수 있는 단계까지 온 것이 거의 실무에서의 테스트 같아서 유익했던 거 같습니다.
눈에 보일 정도의 성능 개선이 된 것 같아 뿌듯했습니다.
